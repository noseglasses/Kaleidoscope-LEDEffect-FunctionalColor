...
FC_CB_START_COLOR_LIST(myCBColorList)

   FC_CB_COLOR(A, aliceblueId)
   FC_CB_COLOR(B, azureId)
...
FC_RGB_START_COLOR_LIST(myRGBColorList)

   FC_RGB_COLOR(A, aliceblue)
   FC_RGB_COLOR(B, azure)
